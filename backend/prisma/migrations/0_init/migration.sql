...
-- CreateEnum
CREATE TYPE "RuleScope" AS ENUM ('GLOBAL', 'CATEGORY', 'TAG', 'PRODUCT');
...
CREATE TABLE "scales" (
    ...
    "name" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "baseSize" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "scale_rules" (
    "id" TEXT NOT NULL,
    "scaleId" TEXT NOT NULL,
    "appliesTo" "RuleScope" NOT NULL,
    "targetId" TEXT,
    "priceMultiplier" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
    "stockMultiplier" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
    "priority" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "scale_rules_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "free_shipping_rules" (
    "id" TEXT NOT NULL,
    "zipCodeStart" TEXT NOT NULL,
    "zipCodeEnd" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "product_variations_scaleId_idx" ON "product_variations"("scaleId");

-- CreateIndex
CREATE UNIQUE INDEX "product_variations_productId_scaleId_key" ON "product_variations"("productId", "scaleId");
...
-- CreateIndex
CREATE INDEX "scales_code_idx" ON "scales"("code");
...
-- AddForeignKey
ALTER TABLE "product_variations" ADD CONSTRAINT "product_variations_scaleId_fkey" FOREIGN KEY ("scaleId") REFERENCES "scales"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "scale_rules" ADD CONSTRAINT "scale_rules_scaleId_fkey" FOREIGN KEY ("scaleId") REFERENCES "scales"("id") ON DELETE CASCADE ON UPDATE CASCADE;
